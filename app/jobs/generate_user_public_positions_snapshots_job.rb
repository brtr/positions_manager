  ...
  def generate_snapshot(snapshot_info)
    SnapshotPosition.transaction do
      ...
      histories.each do |up|
        ...
        snap_shot.update(from_symbol: up.from_symbol, fee_symbol: up.fee_symbol, qty: up.qty, price: up.price, last_revenue: up.last_revenue, notes: up.notes, average_durations: up.average_durations,
